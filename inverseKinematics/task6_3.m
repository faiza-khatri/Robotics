...
T_23 = dh(L2, 0, 0, 0);            % dh transform from frame 2 to 3
setFixedTransform(jnt3, T_23);
...
T_34 = dh(L3, 0, 0, 0);            % dh transform from frame 3 to 4
setFixedTransform(jnt4, T_34);
...
T_ee = dh(L4, 0, 0, 0);            %dh transform from frame 4 to ee
setFixedTransform(ee.Joint, T_ee); % fixed transform, ee doesnt move relative to body4
...
for i = 1:robot.NumBodies
    ...
    disp(robot.Bodies{i}.Collisions)
end